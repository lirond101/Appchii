package com.myRemax.security.filter;
 ...
 * 
 * <b>Package:</b> ar.com.jwt.base.server.com.myRemax.security.filter<br/>
 * 
 * <b>Class:</b> JwtAuthenticationTokenFilter<br/>
 * 
 * <b>Description:</b> Spring com.myRemax.security UsernamePasswordAuthenticationFilter for authentication. <br/>
 * 
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
		...
		if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
			...
			if (jwtTokenUtil.validateToken(authToken, userDetails)) {
				// Do the spring com.myRemax.security stuff.
